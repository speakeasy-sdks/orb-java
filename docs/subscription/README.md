...
* [changeSchedule](#changeschedule) - Schedule plan change
* [create](#create) - Create subscription
* [get](#get) - Retrieve a subscription
* [getCost](#getcost) - View subscription costs
* [getSchedule](#getschedule) - View subscription schedule
* [getUsage](#getusage) - View subscription usage
...
public class Application {
    public static void main(String[] args) {
        try {
                        ...
                        add(new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides6("accusamus", PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides6ModelTypeEnum.BULK_BPS) {{
                            bulkBpsConfig = new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfig() {{
                                tiers = new Orb.Orb.models.operations.PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfigTiers[]{{
                                    ...
                                    add(new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfigTiers(9391.31, "fuga", "est") {{
                                        bps = 7733.32;
                                        maximumAmount = "omnis";
                                        perUnitMaximum = "et";
                                    }}),
            ...
            PostSubscriptionsSubscriptionIdSchedulePlanChangeResponse res = sdk.subscription.changeSchedule(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PostSubscriptionsRequestBody req = new PostSubscriptionsRequestBody() {{
                ...
                minimumAmount = "1.23";
                phaseOverrides = new Orb.Orb.models.operations.PostSubscriptionsRequestBodyPhaseOverrides[]{{
                    add(new PostSubscriptionsRequestBodyPhaseOverrides() {{
                        ...
                        bulkBpsConfig = new PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfig() {{
                            tiers = new Orb.Orb.models.operations.PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfigTiers[]{{
                                add(new PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfigTiers(5502.16, "quo", "ullam") {{
                                    bps = 8464.27;
                                    maximumAmount = "mollitia";
                                    perUnitMaximum = "ipsa";
                                }}),
                                add(new PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfigTiers(4293.44, "cumque", "odio") {{
                                    bps = 4475.03;
                    ...
                    add(new PostSubscriptionsRequestBodyPriceOverrides6("molestias", PostSubscriptionsRequestBodyPriceOverrides6ModelTypeEnum.BULK_BPS) {{
                        bulkBpsConfig = new PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfig() {{
                            tiers = new Orb.Orb.models.operations.PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfigTiers[]{{
                                ...
                                add(new PostSubscriptionsRequestBodyPriceOverrides6BulkBpsConfigTiers(5576.51, "quis", "enim") {{
                                    bps = 6515.04;
                                    maximumAmount = "blanditiis";
            ...
            PostSubscriptionsResponse res = sdk.subscription.create(req);
...
import Orb.Orb.SDK;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdRequest;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdResponse;
import Orb.Orb.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetSubscriptionsSubscriptionIdRequest req = new GetSubscriptionsSubscriptionIdRequest("dignissimos");            

            GetSubscriptionsSubscriptionIdResponse res = sdk.subscription.get(req);
...
import Orb.Orb.SDK;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdCostRequest;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdCostResponse;
import Orb.Orb.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetSubscriptionsSubscriptionIdCostRequest req = new GetSubscriptionsSubscriptionIdCostRequest("laudantium") {{
                groupBy = "dolore";
            ...
            GetSubscriptionsSubscriptionIdCostResponse res = sdk.subscription.getCost(req);

            if (res.getSubscriptionsSubscriptionIdCost200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import Orb.Orb.SDK;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdScheduleRequest;
import Orb.Orb.models.operations.GetSubscriptionsSubscriptionIdScheduleResponse;
import Orb.Orb.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetSubscriptionsSubscriptionIdScheduleRequest req = new GetSubscriptionsSubscriptionIdScheduleRequest("aspernatur");            

            GetSubscriptionsSubscriptionIdScheduleResponse res = sdk.subscription.getSchedule(req);

            if (res.getSubscriptionsSubscriptionIdSchedule200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetSubscriptionsSubscriptionIdUsageResponse res = sdk.subscription.getUsage(req);
...
import Orb.Orb.SDK;
import Orb.Orb.models.operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest;
import Orb.Orb.models.operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesResponse;
import Orb.Orb.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest req = new PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest("ullam");            

            PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesResponse res = sdk.subscription.unschedule(req);

...
public class Subscription {
    ...
    public Orb.Orb.models.operations.FetchSubscriptionResponse fetch(Orb.Orb.models.operations.FetchSubscriptionRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchSubscriptionResponse res = new Orb.Orb.models.operations.FetchSubscriptionResponse(contentType, httpRes.statusCode()) {{
            subscription = null;
        }};
        res.rawResponse = httpRes;
    ...
    public Orb.Orb.models.operations.FetchSubscriptionCostsResponse fetchCosts(Orb.Orb.models.operations.FetchSubscriptionCostsRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchSubscriptionCostsResponse res = new Orb.Orb.models.operations.FetchSubscriptionCostsResponse(contentType, httpRes.statusCode()) {{
            fetchSubscriptionCosts200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchSubscriptionCosts200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchSubscriptionCosts200ApplicationJSON.class);
                res.fetchSubscriptionCosts200ApplicationJSONObject = out;
            }
        }
    ...
    public Orb.Orb.models.operations.FetchSubscriptionScheduleResponse fetchSchedule(Orb.Orb.models.operations.FetchSubscriptionScheduleRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchSubscriptionScheduleResponse res = new Orb.Orb.models.operations.FetchSubscriptionScheduleResponse(contentType, httpRes.statusCode()) {{
            fetchSubscriptionSchedule200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchSubscriptionSchedule200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchSubscriptionSchedule200ApplicationJSON.class);
                res.fetchSubscriptionSchedule200ApplicationJSONObject = out;
            }
        }
    ...
    public Orb.Orb.models.operations.FetchSubscriptionUsageResponse fetchUsage(Orb.Orb.models.operations.FetchSubscriptionUsageRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchSubscriptionUsageResponse res = new Orb.Orb.models.operations.FetchSubscriptionUsageResponse(contentType, httpRes.statusCode()) {{
            fetchSubscriptionUsage200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchSubscriptionUsage200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchSubscriptionUsage200ApplicationJSON.class);
                res.fetchSubscriptionUsage200ApplicationJSONObject = out;
            }
        }
    ...
    public Orb.Orb.models.operations.SchedulePlanChangeResponse schedulePlanChange(Orb.Orb.models.operations.SchedulePlanChangeRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.SchedulePlanChangeResponse res = new Orb.Orb.models.operations.SchedulePlanChangeResponse(contentType, httpRes.statusCode()) {{
            subscription = null;
        }};
        res.rawResponse = httpRes;
    ...
    /**
     * Unschedule pending cancellation
    ...
    public Orb.Orb.models.operations.UnscheduleCancellationResponse unscheduleCancellation(Orb.Orb.models.operations.UnscheduleCancellationRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.UnscheduleCancellationResponse res = new Orb.Orb.models.operations.UnscheduleCancellationResponse(contentType, httpRes.statusCode()) {{
            subscription = null;
        }};
        res.rawResponse = httpRes;
    ...
    public Orb.Orb.models.operations.UnschedulePlanChangeResponse unschedulePlanChange(Orb.Orb.models.operations.UnschedulePlanChangeRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.UnschedulePlanChangeResponse res = new Orb.Orb.models.operations.UnschedulePlanChangeResponse(contentType, httpRes.statusCode()) {{
            subscription = null;
        }};
        res.rawResponse = httpRes;
    ...
    public Orb.Orb.models.operations.UpdateFixedFeeQuantityResponse updateFixedFeeQuantity(Orb.Orb.models.operations.UpdateFixedFeeQuantityRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.UpdateFixedFeeQuantityResponse res = new Orb.Orb.models.operations.UpdateFixedFeeQuantityResponse(contentType, httpRes.statusCode()) {{
            subscription = null;
        }};
        res.rawResponse = httpRes;

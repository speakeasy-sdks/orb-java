 ...
 */
public enum PutCustomersExternalCustomerIdExternalCustomerIdRequestBodyPaymentProviderEnum {
    ...
    private PutCustomersExternalCustomerIdExternalCustomerIdRequestBodyPaymentProviderEnum(String value) {
        this.value = value;
    }
}

...
public class FetchCustomerCostsExternalIdRequest {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=external_customer_id")
    public String externalCustomerId;

    public FetchCustomerCostsExternalIdRequest withExternalCustomerId(String externalCustomerId) {
    ...
    public FetchCustomerCostsExternalIdRequest withGroupBy(String groupBy) {
    ...
    public FetchCustomerCostsExternalIdRequest withTimeframeEnd(String timeframeEnd) {
    ...
    public FetchCustomerCostsExternalIdRequest withTimeframeStart(OffsetDateTime timeframeStart) {
    ...
    public FetchCustomerCostsExternalIdViewMode viewMode;

    public FetchCustomerCostsExternalIdRequest withViewMode(FetchCustomerCostsExternalIdViewMode viewMode) {
        this.viewMode = viewMode;
        return this;
    }
    
    public FetchCustomerCostsExternalIdRequest(@JsonProperty("external_customer_id") String externalCustomerId) {
        this.externalCustomerId = externalCustomerId;
  }
}

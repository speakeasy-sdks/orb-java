...
/**
 * GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts - Price's contributions for the timeframe, excluding any transforms (minimums and discounts).
 */
public class GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts {
    /**

...
public class GetSubscriptionsSubscriptionIdCostRequest {
    /**
    ...
    public GetSubscriptionsSubscriptionIdCostRequest(@JsonProperty("subscription_id") String subscriptionId) {
    this.subscriptionId = subscriptionId;
  }
}

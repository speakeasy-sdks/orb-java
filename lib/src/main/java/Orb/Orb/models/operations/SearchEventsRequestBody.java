...
public class SearchEventsRequestBody {
    /**
    ...
    public SearchEventsRequestBody withEventIds(String[] eventIds) {
    ...
    public SearchEventsRequestBody withInvoiceId(String invoiceId) {

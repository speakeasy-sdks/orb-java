 ...
 */
public class AddLedgerEntryExternalIdRequestBodyInvoiceSettings {
    /**
    ...
    public AddLedgerEntryExternalIdRequestBodyInvoiceSettings withAutoCollection(Boolean autoCollection) {
    ...
    public AddLedgerEntryExternalIdRequestBodyInvoiceSettings withMemo(String memo) {
        this.memo = memo;
        return this;
    }
    ...
    public AddLedgerEntryExternalIdRequestBodyInvoiceSettings withNetTerms(Double netTerms) {
        this.netTerms = netTerms;
        return this;
    }
    
    public AddLedgerEntryExternalIdRequestBodyInvoiceSettings(@JsonProperty("auto_collection") Boolean autoCollection, @JsonProperty("net_terms") Double netTerms) {
        this.autoCollection = autoCollection;
        this.netTerms = netTerms;
  }
}

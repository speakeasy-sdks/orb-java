...
public class AmendEventRequestBody {
    /**
    ...
    public AmendEventRequestBody withCustomerId(String customerId) {
    ...
    public AmendEventRequestBody withEventName(String eventName) {
    ...
    public AmendEventRequestBody withExternalCustomerId(String externalCustomerId) {
    ...
    public AmendEventRequestBody withTimestamp(OffsetDateTime timestamp) {

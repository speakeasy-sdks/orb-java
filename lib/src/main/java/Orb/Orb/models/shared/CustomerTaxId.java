...
/**
 * CustomerTaxId - Tax IDs are commonly required to be displayed on customer invoices, which are added to the headers of invoices.
 * 
 * 
...
public class CustomerTaxId {
    ...
    public CustomerTaxId withCountry(String country) {
    ...
    public CustomerTaxId withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public CustomerTaxId withValue(String value) {
        this.value = value;
        return this;
    }
    
    public CustomerTaxId(@JsonProperty("country") String country, @JsonProperty("type") String type, @JsonProperty("value") String value) {
        this.country = country;
        this.type = type;
        this.value = value;
  }

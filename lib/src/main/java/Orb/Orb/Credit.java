...
public class Credit {
    ...
    /**
     * Add credit ledger entry by external customer ID
    ...
    public Orb.Orb.models.operations.AddLedgerEntryExternalIdResponse addByExternalId(Orb.Orb.models.operations.AddLedgerEntryExternalIdRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.AddLedgerEntryExternalIdResponse res = new Orb.Orb.models.operations.AddLedgerEntryExternalIdResponse(contentType, httpRes.statusCode()) {{
    ...
    public Orb.Orb.models.operations.CreateLedgerEntryResponse create(Orb.Orb.models.operations.CreateLedgerEntryRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.CreateLedgerEntryResponse res = new Orb.Orb.models.operations.CreateLedgerEntryResponse(contentType, httpRes.statusCode()) {{
            creditLedgerEntry = null;
        }};
        res.rawResponse = httpRes;
    ...
    public Orb.Orb.models.operations.FetchCustomerCreditsResponse fetch(Orb.Orb.models.operations.FetchCustomerCreditsRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchCustomerCreditsResponse res = new Orb.Orb.models.operations.FetchCustomerCreditsResponse(contentType, httpRes.statusCode()) {{
            fetchCustomerCredits200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchCustomerCredits200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchCustomerCredits200ApplicationJSON.class);
                res.fetchCustomerCredits200ApplicationJSONObject = out;
            }
        }
    ...
    /**
     * Retrieve credit balance by external customer ID
    ...
    public Orb.Orb.models.operations.FetchCustomerCreditsExternalIdResponse fetchByExternalId(Orb.Orb.models.operations.FetchCustomerCreditsExternalIdRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchCustomerCreditsExternalIdResponse res = new Orb.Orb.models.operations.FetchCustomerCreditsExternalIdResponse(contentType, httpRes.statusCode()) {{
            fetchCustomerCreditsExternalId200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchCustomerCreditsExternalId200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchCustomerCreditsExternalId200ApplicationJSON.class);
                res.fetchCustomerCreditsExternalId200ApplicationJSONObject = out;
            }
        }
    ...
    public Orb.Orb.models.operations.FetchCustomerCreditsLedgerResponse fetchLedger(Orb.Orb.models.operations.FetchCustomerCreditsLedgerRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchCustomerCreditsLedgerResponse res = new Orb.Orb.models.operations.FetchCustomerCreditsLedgerResponse(contentType, httpRes.statusCode()) {{
            fetchCustomerCreditsLedger200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchCustomerCreditsLedger200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchCustomerCreditsLedger200ApplicationJSON.class);
                res.fetchCustomerCreditsLedger200ApplicationJSONObject = out;
            }
        }
    ...
    /**
     * View credits ledger by external customer ID
    ...
    public Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalIdResponse fetchLedgerByExternalId(Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalIdRequest request) throws Exception {
        ...
        Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalIdResponse res = new Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalIdResponse(contentType, httpRes.statusCode()) {{
            fetchCustomerCreditsLedgerExternalId200ApplicationJSONObject = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (Orb.Orb.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalId200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Orb.Orb.models.operations.FetchCustomerCreditsLedgerExternalId200ApplicationJSON.class);
                res.fetchCustomerCreditsLedgerExternalId200ApplicationJSONObject = out;
            }
        }
